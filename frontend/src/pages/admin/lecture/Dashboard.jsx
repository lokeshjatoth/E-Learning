...
import { useGetAllPurchasedCoursesQuery } from "@/features/api/courseApi";
...
const Dashboard = () => {
  ...
  const totalRevenue = purchasedCourses.reduce((total, course) => total + course?.courseId?.coursePrice, 0);
